export type RewardStatus = "ordered" | "payment_pending" | "payment_confirmed" | "voucher_generated" | "delivered" | "confirmed" | "redeemed" | "expired" | "refunded";
export type RewardType = "coupon_cashback" | "platform_bonus" | "non_monetary";
export type MerchantCategory = "food" | "grocery" | "shopping" | "fashion" | "beauty" | "electronics" | "entertainment" | "travel";
export type UserTier = "bronze" | "silver" | "gold" | "platinum";
export type OrderStatus = "initiated" | "payment_pending" | "payment_confirmed" | "payment_failed" | "voucher_generating" | "voucher_generated" | "delivered" | "delivery_failed" | "redeemed" | "expired" | "refund_initiated" | "refund_completed";
...
export interface CouponOrder {
    ...
    voucher_status: "pending_generation" | "generated" | "delivered" | "delivery_failed" | "redeemed" | "expired";
...
export interface RefundEvent {
    ...
    user_id: string;
    amount: number;
    reason: "generation_failed" | "invalid_code" | "user_request" | "expired_unredeemed";
...
export interface EngagementData {
    ...
    hasRecentCouponPurchase?: boolean;
}

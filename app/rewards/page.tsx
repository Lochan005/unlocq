...
export default function RewardsOverviewPage() {
  ...
  return (
    <div className="space-y-10">
      {/* Flow Diagram */}
      <motion.div
        className="grid grid-cols-1 items-center gap-4 md:grid-cols-[1fr_auto_1fr_auto_1fr]"
        {...fadeIn}
      >
        <div className="rounded-2xl border-2 border-emerald-500 bg-gradient-to-br from-emerald-50 to-emerald-100 p-6">
          <h3 className="mb-3 font-bold text-emerald-800">EARN</h3>
          <ul className="space-y-1 text-sm text-emerald-700">
            <li>• Prepay loan (2x points)</li>
            <li>• Shop via partners</li>
            <li>• Refer friends</li>
        ...
        <div className="rounded-2xl border-2 border-blue-500 bg-gradient-to-br from-blue-50 to-blue-100 p-6">
          <h3 className="mb-3 font-bold text-blue-800">GROW</h3>
          <ul className="space-y-1 text-sm text-blue-700">
            <li>• Earnings accumulate</li>
            <li>• Tier bonuses added</li>
        ...
        <div className="rounded-2xl border-2 border-purple-500 bg-gradient-to-br from-purple-50 to-purple-100 p-6">
          <h3 className="mb-3 font-bold text-purple-800">REDEEM</h3>
          <ul className="space-y-1 text-sm text-purple-700">
            <li>• Auto-prepay to loan</li>
            <li>• Redeem vouchers</li>
            <li>• Donate to causes</li>
            <li>• Your choice!</li>
          </ul>
        </div>
      </motion.div>

      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        >
          <p className="text-[#0F0F5C] text-lg leading-relaxed mb-6">
            Unloqs is a personal finance app built for India, created to help individuals understand their loan landscape and identify practical ways to save money through informed prepayments.
          </p>
          ...
          <p className="text-[#0F0F5C] text-lg leading-relaxed mb-6">
            At Unloqs, we believe financial confidence begins with understanding. By showing how small, timely prepayments can meaningfully reduce interest costs and loan tenure, we help users make better decisions on their own terms.
          </p>

          <p className="text-[#0F0F5C] text-lg leading-relaxed mb-6">
            We operate in accordance with applicable Indian laws and data-protection standards. Unloqs is [registered / licensed / not required to be licensed] under [Applicable Act / Authority, if any], with registration number [Number, if applicable]. Where required, we work with regulated partners to ensure responsible handling of user information.
          </p>

          <p className="text-[#0F0F5C] text-lg leading-relaxed">
            Rooted in India and built for India&apos;s borrowers, Unloqs aims to make loans more transparent, savings more visible, and the journey to debt freedom more achievable.
          </p>
        </motion.div>
      </div>
    </div>
